...
namespace CoreBanking.Api.HealthChecks
{
    public class CentralBankCreditCheckApiHealthCheck : IHealthCheck
    {
        ...
        public CentralBankCreditCheckApiHealthCheck(IOptions<BaseUrlConfiguration> baseUrlConfiguration)
        {
        ...
        {
            string myUrl = _baseUrlConfiguration.CentralBankCreditCheckBaseAddress + "api/centralbankcreditcheck/";
